...
<div id="about" class="about">
  ...
  <div style="background:#1f1f1f; border-radius:15px; padding:25px; box-shadow: 0 0 10px #00ffff;">  
    ...
    <p style="text-align: center; color: #fff;">Hey, I'm Muzamil — a passionate software developer who turns coffee into clean code. I build sleek apps, solve real-world problems, and love bringing ideas to life through tech. Currently leveling up my skills, one project at a time.</p>  
  </div>    <!-- Skills -->    
<div id="skills" style="...">
  <!-- skills content -->
...
<div id="contact" style="...">
  ...
  </div>  </div>  <!-- Scan to Pay Full Width Section -->  <div style="margin-top:102px; padding:103px; background: #1f1f1f; border-radius:120px; box-shadow: 0 0 120px #00ffff; text-align: center;">  
  <h2 style="color: #00ffff;">Scan to Pay (PhonePe)</h2>  
  <img src="https://res.cloudinary.com/dxjkbpmgm/image/upload/v1744298764/PhonePeQR_J_K_Grameen_Bank_-_03580_lweegr.png" alt="Scanner" style="max-width:100px; margin-top:120px; border-radius:102px;">  
  <p style="color: #fff; margin-top: 110px;">Secure UPI Payment to Muzamil</p>  
</div> 
