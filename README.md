...
<div id="contact" style="...">
  ...
  </div>  </div>  <!-- Scan to Pay Full Width Section -->  <div style="margin-top: 2px; padding: 3px; background: #1f1f1f; border-radius: 20px; box-shadow: 0 0 12px #00ffff; text-align: center;">  
  <h2 style="color: #00ffff;">Scan to Pay (PhonePe)</h2>  
  <img src="https://res.cloudinary.com/dxjkbpmgm/image/upload/v1744298764/PhonePeQR_J_K_Grameen_Bank_-_03580_lweegr.png" alt="Scanner" style="max-width:100px; margin-top:20px; border-radius:102px;">  
